...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var array|null
         */
        'allowed_remote_hosts' => ['chart.googleapis.com'],
        ...
        'font_family' => [
            'Calibri' => [
                'R' => public_path('fonts/calibri-regular.ttf'),        // Regular
                'B' => public_path('fonts/calibri-bold.ttf'),           // Bold
                'I' => public_path('fonts/calibri-italic.ttf'),         // Italic
                'BI' => public_path('fonts/calibri-bold-italic.ttf'),    // Bold + Italic
                'useOTL' => 0xFF,
                'useKashida' => 75,
            ],
        ],
