...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('implementing_entities', function (Blueprint $table) {
            ...
            $constraints = DB::select("SELECT CONSTRAINT_NAME FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE WHERE TABLE_NAME = 'implementing_entities' AND COLUMN_NAME = 'authority_id' AND REFERENCED_TABLE_NAME IS NOT NULL");
