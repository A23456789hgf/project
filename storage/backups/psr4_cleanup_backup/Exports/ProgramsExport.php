...
class ProgramsExport
{
    ...
    public function export()
    {
        ...
        try {
            Log::info('ProgramsExport: Starting data processing', [
            ...
            $sheet->setTitle('البرامج');

            $sheet->setCellValue('A1', 'تقرير البرامج');
            ...
            Log::info('ProgramsExport: Data retrieved', [
            ...
            $summaryRow = $row + 1;
            $sheet->setCellValue('A'.$summaryRow, 'إجمالي عدد البرامج: '.count($data));
            ...
            Log::info('ProgramsExport: Spreadsheet created successfully', [
            ...
            Log::error('ProgramsExport: Failed to create spreadsheet', [
