...
class EnsureRoutePermission
{
    ...
    protected function resolvePermissionSlug(string $routeName): string
    {
        $specialMappings = [
            ...
            'projects.approval.resubmit' => 'approvals.view',
            ...
            'plans.implementation' => 'plans.edit',
            'plans.implementation.print' => 'plans.print',
            'plans.implementation.update' => 'plans.edit',
            'plans.show-import' => 'plans.create',
            'plans.process-import' => 'plans.create',
