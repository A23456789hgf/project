                ...
                <div class="page-header d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2 class="fw-bold mb-0" style="color: #001f3f;">
                            <i class="fas fa-plus-circle text-success me-2"></i> إضافة توقيع جديد
                        </h2>
                        <div class="title-line"></div>
                    </div>
                </div>

                <form action="{{ route('signatures.store') }}" method="POST" enctype="multipart/form-data" class="modern-form">
                    @csrf
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control custom-field border-start-0 @error('name') is-invalid @enderror" 
                                       placeholder="أدخل الاسم الثلاثي/الرباعي" value="{{ old('name') }}" required>
                            </div>
                            @error('name')
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="job_title" id="job_title" class="form-control custom-field border-start-0 @error('job_title') is-invalid @enderror" 
                                       placeholder="مثال: وزير الزراعة والري" value="{{ old('job_title') }}" required>
                            </div>
                            @error('job_title')
                                <div class="invalid-feedback d-block mt-1">{{ $message }}</div>
                            @enderror
                        ...
                        <!-- Signature Image -->
                        <div class="col-md-12">
                            <label for="signature_image" class="field-label fw-bold mb-2">صورة التوقيع (اختياري)</label>
                            <div class="card bg-light border-dashed p-4 text-center">
                                ...
                                <label for="signature_image" class="cursor-pointer mb-0">
                                    ...
                                    <p class="mb-1 fw-bold">اضغط لرفع صورة التوقيع</p>
