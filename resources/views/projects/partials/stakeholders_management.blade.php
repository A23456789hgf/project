...
<div class="overflow-x-auto rounded-lg shadow mt-8" dir="rtl">
    <table class="min-w-full bg-white">
        <thead class="bg-gray-800 text-white">
            <tr>
                <th class="py-3 px-4 text-end">اسم الكيان</th>
                <th class="py-3 px-4 text-end">النوع</th>
                <th class="py-3 px-4 text-end">المهمة</th>
                <th class="py-3 px-4 text-center">أعضاء الفريق</th>
                <th class="py-3 px-4 text-end">الحالة</th>
            </tr>
        </thead>
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-50">
                    <td class="py-3 px-4">
                        ...
                        @if($summary->entity->is_sub_entity)
                            <span class="text-xs text-blue-600 me-1">(فرعي)</span>
                        @endif
                    </td>
                    ...
                    <td class="py-3 px-4">
                        <span class="px-3 py-1 rounded-full text-xs {{ $statusColor }}">
                            {{ $summary->assigned_team_count > 0 ? 'مُسند' : 'قيد الانتظار' }}
                        </span>
                    </td>
                </tr>
            @endforeach
