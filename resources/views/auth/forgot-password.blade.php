        ...
        <div class="form-section">
            <div class="login-card-modern">
                <div class="form-header">
                    ...
                    <p class="instruction-text">أدخل اسم المستخدم أو رقم هاتفك لإعادة تعيين كلمة المرور</p>
                </div>

                <!-- خطوة 1: إدخال رقم الهاتف أو اسم المستخدم -->
                <div id="step-phone">
                    <div class="custom-input-group">
                        <label for="reset-username">اسم المستخدم أو رقم الهاتف</label>
                        <div class="input-wrapper">
                            <input type="text" id="reset-username" class="custom-form-control"
                                placeholder="أدخل اسم المستخدم أو رقم الهاتف" dir="ltr" inputmode="text">
