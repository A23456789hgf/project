...
<div class="container-fluid px-5 py-4">
    <div class="page-header-box">
        <h2 class="page-main-title">تعديل شكل التمويل: <span style="color: #D4AF37;">{{ $formfinancing->name }}</span></h2>
    ...
    <form action="{{ route('formfinancing.update', $formfinancing->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="row g-4 align-items-end">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control custom-field @error('name') is-invalid @enderror" 
                       ...
                       value="{{ old('name', $formfinancing->name) }}" required>
            </div>
