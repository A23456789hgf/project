                ...
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center">
                        <div class="btn-group" role="group">
                            <a href="{{ route('authorities.downloadTemplate', ['format' => 'csv']) }}" class="btn btn-outline-success">
                                <i class="fas fa-download me-1"></i>
                                تحميل قالب CSV
                            </a>
                            <a href="{{ route('authorities.downloadTemplate', ['format' => 'xlsx']) }}" class="btn btn-outline-primary">
                                <i class="fas fa-download me-1"></i>
                                تحميل قالب Excel
                            </a>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ExcelDragDrop.init({
        ...
        previewUrl: '{{ route("authorities.previewImport") }}',
        templateUrl: '{{ route("authorities.downloadTemplate") }}',
        messages: {
