                ...
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center">
                        <div class="btn-group" role="group">
                            <a href="{{ route('sub-areas.download-template', ['format' => 'csv']) }}" class="btn btn-outline-success">
                                <i class="fas fa-download me-1"></i>
                                تحميل قالب CSV
                            </a>
                            <a href="{{ route('sub-areas.download-template', ['format' => 'xlsx']) }}" class="btn btn-outline-primary">
                                <i class="fas fa-download me-1"></i>
                                تحميل قالب Excel
                            </a>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="mb-3">
                                <li><strong>اسم المنطقة الفرعية:</strong> مطلوب وفريد</li>
                                <li><strong>المحافظة:</strong> مطلوب (اسم المحافظة)</li>
                                <li><strong>المديرية:</strong> مطلوب (اسم المديرية)</li>
                                <li><strong>الحالة:</strong> اختياري (نشط/غير نشط)</li>
                            </ul>
                            
                            <h6 class="text-warning">ملاحظات مهمة:</h6>
                            <ul class="text-muted small">
                                <li>تأكد من وجود المحافظات والمديريات في النظام قبل الاستيراد</li>
                                <li>يجب أن تكون المديرية تابعة للمحافظة المحددة</li>
                                <li>استخدم الأسماء العربية الصحيحة</li>
                                <li>تجنب المسافات الزائدة في بداية أو نهاية الأسماء</li>
                                <li>الحالة الافتراضية هي "نشط" إذا لم تحدد</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ExcelDragDrop.init({
        ...
        previewUrl: '{{ route("sub-areas.preview-import") }}',
        templateUrl: '{{ route("sub-areas.download-template") }}',
        messages: {
            dragEnter: 'اسحب ملف CSV هنا أو انقر للاختيار',
            dragOver: 'اتركه هنا لرفع الملف',
            invalidType: 'نوع الملف غير مدعوم. يرجى اختيار ملف CSV فقط',
