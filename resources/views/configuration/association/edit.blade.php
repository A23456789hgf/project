...
<div class="container-fluid px-5 py-4">
    <div class="page-header-box">
        <h2 class="page-main-title">تعديل الجمعية: <span style="color: #D4AF37;">{{ $association->name }}</span></h2>
        <p class="text-muted small">قم بتحديث بيانات الجمعية ثم اضغط على حفظ التغييرات</p>
        ...
        <div class="row g-4 align-items-end">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control custom-field @error('name') is-invalid @enderror" 
                       name="name" id="name" placeholder="أدخل اسم الجمعية..." 
