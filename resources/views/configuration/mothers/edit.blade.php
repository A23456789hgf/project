...
<div class="container-fluid px-5 py-4">
    <div class="page-header-box">
        <h2 class="page-main-title">تعديل الجهة الأب: <span style="color: #D4AF37;">{{ $mother->name }}</span></h2>
        ...
        <div class="row g-4 align-items-end">
                ...
                <div class="switch-box">
                    <div class="form-check form-switch d-flex align-items-center m-0">
                        <input type="checkbox" class="form-check-input ms-3" style="width: 2.3em; height: 1.1em;" 
                               name="is_active" id="is_active" value="1" {{ $mother->is_active ? 'checked' : '' }}>
            ...
            <div class="col-12 mt-5 pt-4 border-top">
                <div class="d-flex justify-content-end gap-3">
                    <a href="{{ route('mothers.index') }}" class="btn btn-cancel-custom">
