                ...
                <div class="card-body">
                    @if($report['successful'] > 0)
                        <div class="alert alert-success">
                            ...
                            تم استيراد <strong>{{ $report['successful'] }}</strong> برنامج بنجاح.
                        </div>
                    @endif
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        @if($report['failed'] > 0)
                            <a href="{{ route('programs.download-error-report') }}" class="btn btn-outline-danger">
                                <i class="fas fa-download me-1"></i>
                                تحميل تقرير الأخطاء
                            </a>
                        @endif
                        
                        <a href="{{ route('programs.import') }}" class="btn btn-outline-primary">
