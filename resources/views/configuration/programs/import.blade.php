        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">استيراد البرامج من ملف</h6>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="alert alert-info">
                                ...
                                <ul class="mb-0">
                                    ...
                                    <li>يمكنك <a href="{{ route('programs.download-template') }}" class="alert-link">تحميل نموذج</a> للاستيراد</li>
                    ...
                    <form action="{{ route('programs.preview-import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <a href="{{ route('programs.download-template', ['format' => 'csv']) }}" class="btn btn-outline-primary btn-sm">
                                            <i class="fas fa-download"></i> نموذج CSV
                                        </a>
                                        <a href="{{ route('programs.download-template', ['format' => 'xlsx']) }}" class="btn btn-outline-success btn-sm">
