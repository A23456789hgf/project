            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('villages.download-error-report') }}?format=xlsx" class="btn btn-outline-danger">تحميل تقرير الأخطاء (Excel)</a>
                            <a href="{{ route('villages.download-error-report') }}?format=csv" class="btn btn-outline-danger">تحميل تقرير الأخطاء (CSV)</a>
                        </div>
                    ...
                    <div class="alert alert-success">
                        ...
                        @if($report['failed'] == 0)
                        <div class="mt-3">
                            <form action="{{ route('villages.undo-import', ['fileName' => $importedFile]) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="mt-3">
                        <a href="{{ route('villages.index') }}" class="btn btn-primary">العودة إلى قائمة القرى</a>
                        <a href="{{ route('villages.import') }}" class="btn btn-secondary">استيراد ملف آخر</a>
                    </div>
                </div>
            </div>
        </div>
