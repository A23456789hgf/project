                ...
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center">
                        <div class="btn-group" role="group">
                            <a href="{{ route('directorates.download-template', ['format' => 'csv']) }}" class="btn btn-outline-success">
                                <i class="fas fa-download me-1"></i>
                                تحميل قالب CSV
                            </a>
                            <a href="{{ route('directorates.download-template', ['format' => 'xlsx']) }}" class="btn btn-outline-primary">
                                <i class="fas fa-download me-1"></i>
                                تحميل قالب Excel
                            </a>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="mb-3">
                                <li><strong>اسم المديرية:</strong> مطلوب وفريد</li>
                            ...
                            <ul class="text-muted small">
                                <li>تأكد من وجود المحافظات في النظام قبل الاستيراد</li>
...
document.addEventListener('DOMContentLoaded', function() {
    ExcelDragDrop.init({
        ...
        previewUrl: '{{ route("directorates.preview-import") }}',
        templateUrl: '{{ route("directorates.download-template") }}',
        messages: {
