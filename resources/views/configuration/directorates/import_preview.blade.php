    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card import-preview-card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('directorates.process-import') }}" method="POST" id="importForm" class="import-form">
                        @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            @if(in_array($field, ['name', 'governorate_name']))
                                                <span class="badge bg-danger ms-2">مطلوب</span>
                                            @endif
                                        </td>
                                        <td>
                                            <select name="mapping[{{ $field }}]" class="form-select" {{ in_array($field, ['name', 'governorate_name']) ? 'required' : '' }}>
                                                <option value="">-- اختر العمود --</option>
                                                @foreach($headers as $header)
                                                    <option value="{{ $header }}" 
                                                        @if(
                                                            ($field === 'name' && (str_contains(strtolower($header), 'name') || str_contains(strtolower($header), 'اسم') || str_contains(strtolower($header), 'مديرية'))) ||
